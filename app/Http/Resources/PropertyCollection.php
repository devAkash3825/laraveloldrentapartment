    ...
    public function toArray($request): array
    {
        return $this->collection->map(function($property){
            return [
                ...
                'leaseinfo' => $property->newAdditionalInfo->LeasingTerms ?? '',
                'pets' => $property->newAdditionalInfo->PetPolicy ?? '',
                'school' => $property->newAdditionalInfo->Schools ?? '',
                'qualifycriteria' => $property->newAdditionalInfo->QualifiyingCriteria ?? '',
                'parking' => $property->newAdditionalInfo->Parking ?? '',
                'communitydescription' => $property->communitydescription->Description ?? '',
                'agentcomments' => $property->communitydescription->Agent_comments ?? '',
                'drivedirection'=> $property->newAdditionalInfo->drivedirection ?? '',
                'neighborhood'=> $property->newAdditionalInfo->Neighborhood ?? '',
