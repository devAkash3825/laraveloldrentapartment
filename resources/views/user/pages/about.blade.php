...
<div class="header-premium-gradient py-5 mb-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="text-white fw-bold display-5 mb-2">About Us</h1>
                <p class="text-white opacity-75 lead mb-0">Learn more about our mission and services</p>
            </div>
            <div class="col-md-6 text-md-end mt-4 mt-md-0">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-md-end mb-0">
                        ...
                        <li class="breadcrumb-item active text-white fw-bold small" aria-current="page">About Us</li>
                    </ol>
                </nav>
            </div>
        </div>
