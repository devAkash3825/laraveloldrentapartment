                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            @if (count($data) > 0)
                                @foreach ($data as $row)
                                    <div class="col-md-12">
                                        <div class="card sample-Pcard mb-4 mt-3">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                ...
                                                                <span class="card-caption">{{ $row['username'] }}</span>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row sample-padding-t10">
                                                            <div class="col-md-6">
                                                                ...
                                                                <span
                                                                    class="pcard-title-caption">{{ $row['address'] }}</span>
                                                            </div>
                                                            <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <span
                                                                    class="pcard-title-caption">{{ $row['company'] }}</span>
                                                            </div>
                                                        </div>
                                                        @php
                                                            $communityFeatures = $row['features'];
                                                            $featureIds = explode(',', $communityFeatures);
                                                            $features = App\Models\ApartmentFeature::whereIn(
                                                                'id',
                                                                $featureIds,
                                                            )
                                                                ->take(3)
                                                                ...
                                                                <div class="row">
                                                                    @if (count($features) > 0)
                                                                        @foreach ($features as $feature)
                                                                            <span
                                                                                class="col-md-4 pcard-title-caption">{{ $feature->PropertyFeatureType }}</span>
                                                                        @endforeach
                                                                    @else
                                                                        <span class="col-md-12 pcard-title-caption">
                                                                            -------------------------------------- No
                                                                            Features Selected Yet
                                                                            ---------------------------------------- </span>
                                                                    @endif
                                                                </div>
                                                            </div>
                ...
                geocoder.geocode({
                    ...
                    streetViewService.getPanoramaByLocation(latlon, 50, function(data, status) {
                        if (status == google.maps.StreetViewStatus.OK) {
                            ...
                            panorama = new google.maps.StreetViewPanorama(document.getElementById("streetviewfull"), panoramaOptions);
