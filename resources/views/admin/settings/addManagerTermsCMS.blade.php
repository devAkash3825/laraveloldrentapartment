    ...
    <div class="container">
        <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Manager Terms</li>
            </ol>
            <h6 class="slim-pagetitle">Add Manager Terms & Conditions</h6>
        </div>
        
        <div class="form-card">
            <form id="addmanagerterms">
                @csrf
