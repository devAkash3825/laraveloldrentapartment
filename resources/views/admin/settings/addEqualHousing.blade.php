    ...
    <div class="container">
        <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Equal Housing</li>
            </ol>
            <h6 class="slim-pagetitle">Add Equal Housing Information</h6>
        </div>
        
        <div class="form-card">
            <form id="addequalhousing">
                @csrf
                <div class="form-group mb-4">
                    <label class="form-label">Title <span class="text-danger">*</span></label>
                    <input type="text" name="title" id="title" class="form-control" placeholder="Enter Section Title" required>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#addequalhousing").submit(function(e) {
            e.preventDefault();
            var url = "{{ route('admin-create-housing') }}";
