...
@section('content')
@section('title', 'RentApartement | Referred Renter ')
<style>
    .table-green tr th {
        background-color: #0a5d4d;
        color: #fff;
    }
</style>
                ...
                <div class="col-12 text-center text-white">
                    ...
                    <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> Referred Renter </li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                            ...
                                                            @foreach ($rec as $row)
                                                                <tr>
                                                                    <td class="text-center">
                                                                        <span
                                                                            class="badge bg-primary rounded-pill">{{ $loop->iteration }}</span>
                                                                    </td>
                                                                    <td>
                                                                        <a href="#"
                                                                            class="text-decoration-none fw-semibold text-primary">
                                                                            {{ @$row->loginrenter->renterinfo->Firstname }}
                                                                            {{ @$row->loginrenter->renterinfo->Lastname }}
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <span class="text-muted">
                                                                            {{ $row->created_at ? \Carbon\Carbon::parse($row->created_at)->format('Y-m-d') : 'Not Available' }}
                                                                        </span>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <div
                                                                            ...
                                                                            <a href="{{ route('manager-message', ['p_id' => $row->propertyinfo->Id, 'r_id' => $row->loginrenter->Id]) }}"
                                                                    ...
                                                                    <td>
                                                                        <strong>{{ $row->propertyinfo->PropertyName ?? 'N/A' }}</strong>
                                                                        <small class="text-muted d-block">
                                                                            {{ $row->propertyinfo->Address }}
                                                                        </small>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                                            ...
                                                                            <div class="empty-state__content">
                                                                                <div class="empty-state__icon">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                                        ...
                                                                                        <path fill="#C73F43"
                                                                                            d="M496.691 39.383V15.261H241.077v24.122z" />
                                                                                        <path fill="#F8EFE0"
                                                                                ...
                                                                                <div class="empty-state__message">No
                                                                                    Current Active Referrals.</div>
                                                                            </div>
                                                                        </div>
                                                                    </section>
                                                                </td>
