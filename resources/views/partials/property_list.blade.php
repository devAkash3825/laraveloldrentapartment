...
@if (isset($propertyDetails) && is_countable($propertyDetails) && count($propertyDetails) > 0)
    @foreach ($propertyDetails as $row)
        <div class="col-lg-3 col-md-6 col-sm-12 grid-item">
            <div class="property-item rounded overflow-hidden">
                <div class="position-relative overflow-hidden">
                    <a href="{{ route('property-display', ['id' => $row['Id']]) }}" class="w-100">
                        @php
                        ...
                        @if ($imageName)
                            <img 
                            class="grid-property-img" src="https://rentapartment.s3.ap-southeast-2.amazonaws.com/Gallery/Property_{{ $row['Id'] }}/Original/{{ $imageName }}" alt="Property Image">
                        @else
                            <img class="grid-property-img" src="{{ asset('img/no-img.jpg') }}" alt="Default Image">
                        @endif
                    </a>
                </div>
                <div class="px-3 py-3">
            ...
            <div class="empty-state__content">
                <div class="empty-state__icon">
                    <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision"
                        ...
                        clip-rule="evenodd" viewBox="0 0 512 481.322">
                        <path fill="#363C56"
