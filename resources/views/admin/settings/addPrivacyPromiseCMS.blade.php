    ...
    <div class="container">
        <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Privacy Promise</li>
            </ol>
            <h6 class="slim-pagetitle">Add Privacy Promise</h6>
        </div>
        
        <div class="form-card">
            <form id="addprivacypromise">
                @csrf
...
<script>
    $(document).ready(function() {
        ...
        $("#addprivacypromise").submit(function(e) {
            e.preventDefault();
            var url = "{{ route('admin-create-privacy-promise') }}";
