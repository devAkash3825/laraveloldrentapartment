...
// const notedetail = document.getElementsByClassName('getnotedetails');
...
// getNoteDetails
// notedetail.addEventListener('click', function(){
//   let propertyId = notedetail.getAttribute("data-id");
//   try {
//     $.ajax({
...
// for populating todos whenever there is some update 
