        ...
        <div class="content-chat-message-user active">
            <div class="head-chat-message-user">
                ...
                <div class="message-user-profile">
                    <h4 class="mt-3 mb-0 text-white"><strong> {{ $getPropertyInfo->PropertyName }}</strong></h4>
                </div>
            </div>
                            ...
                            @if ($conversation->adminId == Auth::guard('admin')->user()->Id)
                                <div class="message-user-left">
                                    <div class="message-user-left-img">
                                        ...
                                        <small>{{ $conversation->created_at->format('d M, Y, h:i A') }}</small>
                                    </div>
                            ...
                            @else
                                <div class="message-user-right">
                                    <div class="message-user-right-img">
                                        <p class="mt-0 mb-0"><strong>{{ Auth::guard('admin')->user()->admin_name }}</strong>
                                        </p>
                                        <small>{{ $conversation->created_at->format('d M, Y, h:i A') }}</small>
            ...
            <!-- Message Input Area -->
            <form class="footer-chat-message-user" id="sendMessageForm">
                <div class="message-user-send">
                    <input type="text" id="adminmessage" name="adminmessage" placeholder="Enter Your Message ">
                    <input type="hidden" id="sendpropertyId" name="sendpropertyID" value="{{ $getPropertyInfo['Id'] }}"
                        placeholder="Enter Your Message ">
                    <input type="hidden" id="sendrenterId" name="sendrenterId" value="{{ $renterId }}"
                        placeholder="Enter Your Message ">
                </div>
