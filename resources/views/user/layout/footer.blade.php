@php
    $footerInfo = \App\Models\FooterInfos::first();
@endphp
<footer>
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-7">
                    <ul class="footer_bottom_link">
                        @foreach (Menu::getByName('Footer Menu Four') as $footerMenuFour)
                        <li><a href="{{ $footerMenuFour['link'] }}"> {{ $footerMenuFour['label'] }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
